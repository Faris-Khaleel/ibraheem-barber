...
- Mobile is a first-class presentation: keep the transformation subject large enough to read, keep its chapter rail clear of the floating booking control, and hide the floating WhatsApp control from the Contact section onward so it never obscures the phone actions.
