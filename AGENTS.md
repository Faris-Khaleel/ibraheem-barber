...
- The transformation must prioritize physical-phone smoothness and realism: use the approved single 24 fps human transformation film as native video, not Blender characters, a WebGL frame decoder, or per-frame network requests. Keep the video background continuous with the warm-white section and avoid backdrop blur over it.
